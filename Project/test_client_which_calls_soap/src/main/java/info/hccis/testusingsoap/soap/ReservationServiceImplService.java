 ...
 * 
 */
@WebServiceClient(name = "ReservationServiceImplService", targetNamespace = "http://soap.restaurant.reservation.hccis.info/", wsdlLocation = "file:/C:/Bitbucket/cis2232_20242025_project_ashton_sherri_reservation/Project/test_client_which_calls_soap/src/wsdl/localhost_8083/reservationservice.wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESERVATIONSERVICEIMPLSERVICE_QNAME = new QName("http://soap.restaurant.reservation.hccis.info/", "ReservationServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Bitbucket/cis2232_20242025_project_ashton_sherri_reservation/Project/test_client_which_calls_soap/src/wsdl/localhost_8083/reservationservice.wsdl");
    ...
    public ReservationService getBusPassServiceImplPort() {
        return super.getPort(new QName("http://soap.restaurant.reservation.hccis.info/", "ReservationServiceImplPort"), ReservationService.class);
    }
    ...
    public ReservationService getReservationServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.restaurant.reservation.hccis.info/", "ReservationServiceImplPort"), ReservationService.class, features);
    }
