...
INSERT INTO codeType (codeTypeId, englishDescription, frenchDescription, createdDateTime, createdUserId, updatedDateTime, updatedUserId)
VALUES
...
INSERT INTO codeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId)
VALUES
    (1, 1, 'Standard', 'STD', '2024-01-01 00:00:00', 'admin', '2024-01-01 00:00:00', 'admin'),
...
INSERT INTO reservation (name, email, reservationDateTime, reservationTypeId, numberOfAdults, numberOfSeniors, numberOfChildren, couponDiscount, totalCost)
VALUES
    ('John Doe', 'john.doe@example.com', '2024-08-15 18:30', 1, 2, 1, 0, 0.1, 63.75),
