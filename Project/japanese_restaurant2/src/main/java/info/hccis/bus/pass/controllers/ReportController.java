...
import info.hccis.bus.pass.dao.TicketOrderDAO;
import info.hccis.bus.pass.entity.ReportOrder;
...
public class ReportController {
    ...
    public String reportOrderDateOfOrder(Model model) {
        ...
        //prove making connection to the database.
        BusPassDAO busPassDAO = new BusPassDAO();
        int count = busPassDAO.selectAll().size();
        logger.info("Testing the dao, there were "+count+" rows in the database.");
