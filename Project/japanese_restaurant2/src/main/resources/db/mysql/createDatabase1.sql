...
# INSERT INTO buspass (id, name, address, city, preferredRoute, passType, validForRuralRoute, lengthOfPass, startDate,cost) VALUES (0, 'Muhammad Fayyaz', '123 There Dr.', 'Charlottetown', 1, 2, 1, 31, '2024-10-01',0);
# INSERT INTO buspass (id, name, address, city, preferredRoute, passType, validForRuralRoute, lengthOfPass, startDate,cost) VALUES (0, 'Marcie Henderson', '123 There Dr.', 'Charlottetown', 1, 2, 1, 365, '2024-10-01',0);
INSERT INTO buspass (id, name, address, city, preferredRoute, passType, validForRuralRoute, lengthOfPass, startDate, cost) VALUES
 (1, 'Muhammad Fayyaz', '123 There Dr.', 'Charlottetown', '1', 2, 1, 31, '2024-10-01', 0.00),
(2, 'Marcie Henderson', '123 There Dr.', 'Charlottetown', '1', 2, 1, 365, '2024-10-01', 0.00),
(3, 'Jappreet Singh', '222 Some St.', 'Stratford', '2', 1, 1, 7, '2024-10-04', 0.00);