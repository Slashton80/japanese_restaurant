...
INSERT INTO CodeType (CodeTypeId, englishDescription, frenchDescription, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 'Skill Types Technical', 'Skill Types Technical FR', sysdate(), '', CURRENT_TIMESTAMP, '');
INSERT INTO CodeType (CodeTypeId, englishDescription, frenchDescription, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 'Skill Types Technical Points', 'Skill Types Technical Points FR', sysdate(), '', CURRENT_TIMESTAMP, '');
...
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 3, 'Number Forehand Drives', 'NFD', 'Number Forehand DrivesFR', 'NFD', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 4, 'Number Backhand Drives', 'NBD', 'Number Backhand DrivesFR', 'NBD', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 5, 'Forehand Volley Max', 'FVM', 'Forehand Volley MaxFR', 'FVM', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 6, 'Forehand Volley Sum', 'FVS', 'Forehand Volley SumFR', 'FVS', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 7, 'Backhand Volley Max', 'BVM', 'Backhand Volley MaxFR', 'BVM', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (2, 8, 'Backhand Volley Sum', 'BVS', 'Backhand Volley SumFR', 'BVS', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');

INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 9, '15', '15', '15', '15', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 10, '15', '15', '15', '15', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 11, '8', '8', '8', '8', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 12, '5', '5', '5', '5', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 13, '8', '8', '8', '8', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
INSERT INTO CodeValue (codeTypeId, codeValueSequence, englishDescription, englishDescriptionShort, frenchDescription, frenchDescriptionShort, createdDateTime, createdUserId, updatedDateTime, updatedUserId) VALUES
    (3, 14, '5', '5', '5', '5', '2023-10-25 18:44:37', 'admin', '2023-10-25 18:44:37', 'admin');
...
) ENGINE=InnoDB COMMENT='This table stores reservation details.';


---------------------------------------------------------------------------------- Note the table below to hold data associated with your project.  Expect one-- table with 7-9 fields./*Table Name: reservationsDescription:This table stores information about reservations made for a specific event or service. It keeps track of the number ofseniors, children, and adults attending, along with discounts applied and the final bill calculation.Fields:- ID (INT, AUTO_INCREMENT, PRIMARY KEY): Unique identifier for each reservation.- Name (VARCHAR(100), NOT NULL): Name of the person making the reservation.- Number_Of_Seniors (INT, NOT NULL): Number of seniors attending the event.- Number_Of_Children (INT, NOT NULL): Number of children attending the event.- Number_Of_Adults (INT, NOT NULL): Number of adults attending the event.- Number_Of_Customers (INT, STORED GENERATED): Automatically calculated as the sum of seniors, children, and adults.- Coupon_Discount (DOUBLE, DEFAULT 0.30): Discount applied to the total bill (30% off by default).- Date_Time (DATETIME, NOT NULL): The date and time of the reservation.- Entry_Cost_Per_Customer (INT, DEFAULT 25): The entry cost per customer, defaulted to $25 per customer.- Children_Discount (DOUBLE, DEFAULT 0.20): Discount applied to children’s tickets (20% off by default).- Senior_Discount (DOUBLE, DEFAULT 0.15): Discount applied to seniors’ tickets (15% off by default).- Final_Bill (DOUBLE, STORED GENERATED): Automatically calculated final bill based on the number of customers and discounts.Business Logic:- The Number_Of_Customers is generated as the sum of seniors, children, and adults.- Final_Bill is calculated based on the number of customers, the entry cost per customer, and the applicable discounts for children, seniors, and any coupon discounts.*/CREATE TABLE Reservations (                              id int auto_increment primary key,                              name varchar(100) not null,                              numberOfSeniors int not null,                              numberOfChildren int not null,                              numberOfAdults int not null,                              numberOfCustomers int generated always as (numberOfSeniors + numberOfChildren + numberOfAdults) stored,                              couponDiscount double default 0.30,                              dateTime datetime not null,                              entryCostPerCustomer int default 25,                              childrenDiscount double default 0.20,                              seniorDiscount double default 0.15,                              finalBill double generated always as (                                  (numberOfCustomers * entryCostPerCustomer)                                      - (numberOfChildren * entryCostPerCustomer * childrenDiscount)                                      - (numberOfSeniors * entryCostPerCustomer * seniorDiscount)                                      - (numberOfCustomers * entryCostPerCustomer * couponDiscount)                                  ) stored);
