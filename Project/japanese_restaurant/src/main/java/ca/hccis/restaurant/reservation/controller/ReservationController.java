...
//        ReservationBO.setReservationTypes(_cvr, session);
//
//        Optional<Reservation> reservation = _bpr.findById(id);
//        if (reservation.isPresent()) {
//            // Format date for datetime-local input
//            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm");
//            reservation.get().setFormattedReservationDateTime(
//                    reservation.get().getReservationDateTime().format(formatter)
//            );
...
//            bindingResult.rejectValue("reservationDateTime", "error.reservation", "Reservation date must be today or later.");
//            model.addAttribute("reservation", reservation);
//            return "reservation/add";
//        }
//
//        if (!ReservationValidationBO.validateNumberOfAdultsOrSeniors(reservation)) {
//            bindingResult.rejectValue("numberOfAdults", "error.reservation", "At least one adult or one senior must be included in the reservation.");
//            model.addAttribute("reservation", reservation);
//            return "reservation/add";
//        }
